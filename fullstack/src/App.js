...
class App extends Component {
  ...
  addCustomerContact(contact) {
   ...
   //DB this.addCustomerContactToDB(contact);
  }
  ...
  addCustomerToHash(customer) {
    ...
    this.placeArrIntoHashFromDB(holder, 20) 
  ...
  addCustomer(customer) {
    //DB this.addCustomerToDB(customer);
    //this.addCustomerToArr(customer);
    customer.setID('DEMO-DEFAULT');
  ...
  deleteAssociatedContacts(customer) {
    ...
    //DB DEMO this.deleteCascadeContactsDB(customer);
  }

  onDelete(customer) {
    this.deleteAssociatedContacts(customer);
    //DB this.deleteFromDB(customer);
